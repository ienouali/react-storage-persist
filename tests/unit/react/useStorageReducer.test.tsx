...
describe('useStorageReducer', () => {
  ...
  it('should initialize with initial state', () => {
    const { result } = renderHook(() => useStorageReducer('counter', counterReducer, { count: 0 }));
  ...
  it('should handle decrement action', () => {
    const { result } = renderHook(() => useStorageReducer('counter', counterReducer, { count: 5 }));
  ...
  it('should work with complex state', async () => {
    ...
    const { result } = renderHook(() => useStorageReducer('todos', todoReducer, { todos: [] }));
    ...
    act(() => {
      result.current[1]({ type: 'remove', id: 1 });
    });
